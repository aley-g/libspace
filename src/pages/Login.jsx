...
const Login = () => {
  ...
  const { loginWithEmail, registerWithEmail, resetPassword, user, loading, error } = useAuthStore();
    ...
    <div className="flex flex-col bg-white min-h-screen">
      ...
      <div className="relative z-20 -mt-32 max-w-xl mx-auto px-4 sm:px-6 w-full mb-24">
        <div className="bg-white rounded-[2rem] shadow-2xl shadow-primary/10 p-8 sm:px-16 sm:py-10 border border-gray-100">
          ...
          {isForgotPassword && (
            <div className="text-center mb-6 bg-slate-50 p-4 rounded-xl border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {isForgotPassword && (
              <button 
                ...
                className="w-full py-2 mt-2 text-sm font-bold text-gray-500 hover:text-gray-800 transition-colors"
              >
                Back to Sign In
              </button>
            )}
